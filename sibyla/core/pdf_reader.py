...
def extrair_imagens_da_pagina(fitz_doc, page_index: int) -> list:
    """
    Returns list of dicts {bytes, y_top} with images embedded in the page,
    sorted by vertical position. All images are converted to PNG.
    """
...
def extrair_blocos_pagina(page) -> list:
    """
    Extracts text blocks grouping nearby lines into paragraphs.
    Each block: {texto, tamanho, negrito, italico, x0, y_top, y_bot}
    """
